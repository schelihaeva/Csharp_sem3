...
<<<<<<< HEAD
double n1 = 5.8; // double - переменная вещественного типа,округляет до целого числа
=======
double n1 = 5.8; // double - переменная вещественного типа, округляет до целого числа
>>>>>>> ead18f9be090938993679856cc07cdba4d60fe37
int n2 = (int)n1; // приводим к целому числовому типу
